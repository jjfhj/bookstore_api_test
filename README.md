...
- [x] Запросы <code>GET</code>, <code>POST</code> и <code>DELETE</code>
    - [x] Успешная генерация токена
    - [x] Отображение списка всех книг
    - [x] Отображение определенной книги по ISBN в списке всех книг
    - [x] Добавление и удаление книги в профиле пользователя
- [x] Отображение <code>statusCode</code> и <code>body</code> в ответе запроса
- [x] Соответствие <code>body</code> ответа <code>JSON Schema</code>
- [x] Отображение значений ключа в соответствии с проверкой на <code>Groovy</code>
